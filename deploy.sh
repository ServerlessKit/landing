...
show_deployment_options() {
    ...
    echo "   - Set source: Deploy from branch 'main'"
    echo "   - Automatic deployments on git push"
    echo "   - Free SSL certificate via Cloudflare"
    echo ""
    echo "2. 🌐 Cloudflare DNS Configuration"
    echo "   - Add CNAME record: @ → serverlesskit.github.io"
    echo "   - Add CNAME record: www → serverlesskit.com"
    echo "   - Enable proxy (orange cloud)"
    echo "   - Set SSL/TLS to 'Full (strict)'"
    echo ""
    echo "3. ✅ Verification"
    echo "   - Test https://serverlesskit.com"
    echo "   - Test form submission"
    echo "   - Check Google Sheets integration"
    echo ""
}
